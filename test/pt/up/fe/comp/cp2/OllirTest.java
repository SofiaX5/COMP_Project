...
public class OllirTest {
    ...
    public void section1_Basic_Fields_Declaration() {
        ...
        var fieldTypes = new HashSet<>(Arrays.asList("int", "boolean", "BasicFields", "int[]"));
    ...
    public void section1_Basic_Methods_Bool() {
        ...
        // Check return type
        CpUtils.assertEquals("Method return type", "boolean", CpUtils.toString(method.getReturnType()), result);
    ...
    public void section1_MiscConditionArgsFuncCall() {
        ...
        for (int i = 0; i < 4; i++) {
            CpUtils.assertEquals("Method parameter type should be boolean",
                    "boolean", CpUtils.toString(funcMethod.getParams().get(i).getType()), result);
        }
    }
    ...
    public void section1_MiscFuncArgsFuncCall() {
        ...
        CpUtils.assertEquals("Second parameter type", "boolean", CpUtils.toString(funcMethod.getParams().get(1).getType()), result);
    }
